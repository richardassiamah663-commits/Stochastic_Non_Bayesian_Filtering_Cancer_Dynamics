...
state_names = ['NC(x1)', 'CC(x2)', 'EC(x3)', 'CA(y)', 'AA(w)']
...
header = "Run | " + " | ".join([f"{n:>8s}" for n in state_names])
print(header)
print("-" * len(header))
...
fig.suptitle(f'Figure 4.  EnKF State/Parameter Estimation: '
...
# =============================================================================
# 8. RMSE OVER TIME PLOT (Replicating Paper Figure 6 for x1, x3)
# =============================================================================
...
fig_rmse.suptitle('RMSE x1 and x3 States (EnKF)', 
...
fig_rmse.savefig('enkf_rmse_fig6_replication.png', dpi=180, bbox_inches='tight')
print("\nRMSE over time plot saved as: enkf_rmse_fig6_replication.png")
